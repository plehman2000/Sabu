...
#MODELPATH = os.getcwd() + '/DataModelling/getEmotions/sentimentModel/'
MODELPATH = 'C:/Users/gabri/Desktop/Coding Projects/GAITOR/Emotion Detection/DataModelling/getEmotions/emotionModel/'
...
class BertClassifier(nn.Module):
    ...
    def __init__(self, dropout=0.5):
        ...
        # Changed number of outputs in linear layer from 3 to 4.
        self.layer1 = nn.Sequential(nn.Dropout(dropout), nn.Linear(768, 100),
                                    nn.ReLU(), nn.Linear(100, 4), nn.ReLU())
...
def getEmotionAverage(samples, disp=False, optimize=False):
    ...
    if disp:
        print(
            f'{100*avgs[0]:.2f}% Fear, {100*avgs[1]:.2f}% Sadness {100*avgs[2]:.2f}% Joy, {100*avgs[0]:.2f}% Anger')
    return avgs
